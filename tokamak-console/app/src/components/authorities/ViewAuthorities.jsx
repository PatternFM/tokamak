        ...
        return (
              ...
              <MuiThemeProvider>
                <div>
                  <div id="header">
                    ...
                    <button className="tok-button fixed-top" onClick={() => this.refs.manageAuthorityDialog.show()}>+ Create Authority</button>
                  </div>
            ...
            {!moreThanOneResult &&
              <div className="error-page">
                ...
                <br/><br/>
                <button className="tok-button center" onClick={() => this.refs.manageAuthorityDialog.show()}>+ Create Authority</button>
              </div>
            }
            </div>
        );
