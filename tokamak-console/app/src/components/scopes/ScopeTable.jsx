    ...
    render() {
        return (
                <table className="display-table">
                  <thead>
                    <tr>
                      <th className="dth left-pad-0" align="left">Scope</th>
                  ...
                  <tbody>
                    {this.props.scopes.map((scope) => 
                     <tr>
                       ...
                       <td className="dtr" align="left">{scope.id}</td>
                       <td className="dtr" align="left"><Timestamp time={scope.created/1000} format="full" /></td>
